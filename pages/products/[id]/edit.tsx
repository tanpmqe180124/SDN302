...
export default function EditProduct() {
  ...
  if (!session) return <div className="p-8">You must be logged in to edit a product.</div>;
  ...
  return (
    <div className="max-w-xl mx-auto py-8 px-4">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-2xl transition">
        <h2 className="text-3xl font-extrabold mb-6 text-center text-blue-700 drop-shadow">Edit Product</h2>
        ...
        <button type="submit" className="w-full bg-blue-600 text-white py-2 rounded-lg font-semibold hover:bg-blue-700 transition">Update Product</button>
      </form>
    </div>
  );
}
